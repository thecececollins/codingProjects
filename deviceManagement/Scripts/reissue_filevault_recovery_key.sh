...
PROMPT_MESSAGE="Your Mac's FileVault encryption key needs to be escrowed by Simple IT. Feel free to open an issue in it/help on GitHub if you have any questions.
...
FAIL_MESSAGE="Sorry, an error occurred while escrowing your FileVault key. Please submit an issue to it/help in GitHub for help."
...
PROFILE_IDENTIFIER_10_12="CA3ED877-DA2B-406C-A77F-EFAFFD0AC1D8" # 10.12 and earlier
PROFILE_IDENTIFIER_10_13="9DD04AAF-14AD-4AF5-ABDE-6AD23CD2D078" # 10.13 and later
